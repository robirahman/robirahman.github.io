...
|---|---|
| তুমি কী **করা**? | তুমি কী **করছ**? *(What are you doing?)* |
| আমি ভাত **খাওয়া**। | আমি ভাত **খাচ্ছি**। *(I am eating rice.)* |
| সে বই **পড়া**। | সে বই **পড়ছে**। *(She is reading a book.)* |
...
2. **Decide which case applies:**
   ...
   **What to write in `corrected_example`:**
   ...
   - ✅ "খাওয়া ভালো।" — *"Eating is good."* (gerund as subject) → OK
   - ✅ "সাঁতার কাটা শিখতে হবে।" — *"You need to learn to swim."* → OK
